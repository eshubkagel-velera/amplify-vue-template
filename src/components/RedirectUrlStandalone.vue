<template>
  <div class="redirect-url-standalone">
    ...
    <!-- Product Selection -->
    <div v-if="!props.productId" class="product-selection">
    ...
    <!-- Action Buttons -->
    <div v-if="selectedProductId || props.productId" class="action-buttons">
    ...
    <!-- Redirect URLs List -->
    <div v-if="selectedProductId || props.productId" class="url-list">
        ...
        <table class="url-table">
          ...
          <tbody>
            <tr v-for="url in filteredUrls" :key="url.REDIRECT_URL_ID">
              ...
              <td>{{ url.URL_TYPE_CODE === 'E' ? 'Existing Users' : url.URL_TYPE_CODE === 'N' ? 'New Users' : url.URL_TYPE_CODE }}</td>
              <td>{{ url.URL }}</td>
              <td>{{ url.RESPONSE_TEXT }}</td>
              <td>{{ formatDate(url.CREATED_DATE) }}</td>
              <td>{{ url.CREATED_BY_USER_ID }}</td>
              <td>{{ formatDate(url.CHANGED_DATE) }}</td>
              <td>{{ url.CHANGED_BY_USER_ID }}</td>
              <td>
