...
/**
 * Deletes an item with STEP_SERVICE_MAPPING_ID `ctx.args.input.STEP_SERVICE_MAPPING_ID` from the STEP_SERVICE_MAPPING table.
 * @param {import('@aws-appsync/utils').Context} ctx the context
 * @returns {*} the request
 */
export function request(ctx) {
    const { input: { STEP_SERVICE_MAPPING_ID }, condition = {} } = ctx.args;
    const where = {
        ...condition,
