...
/**
 * Sends a request to get an item with STEP_SERVICE_MAPPING_ID `ctx.args.STEP_SERVICE_MAPPING_ID` from the STEP_SERVICE_MAPPING table.
 * @param {import('@aws-appsync/utils').Context} ctx the context
 * @returns {*} the request
 */
export function request(ctx) {
    const { STEP_SERVICE_MAPPING_ID } = ctx.args;
    const where = {
