...
/**
 * Deletes an item with STEP_TYPE_PARAM_MAP_ID `ctx.args.input.STEP_TYPE_PARAM_MAP_ID` from the STEP_TYPE_PARAM_MAP table.
 * @param {import('@aws-appsync/utils').Context} ctx the context
 * @returns {*} the request
 */
export function request(ctx) {
    const { input: { STEP_TYPE_PARAM_MAP_ID }, condition = {} } = ctx.args;
    const where = {
        ...condition,
