...
/**
 * Deletes an item with SERVICE_PARAM_MAPPING_ID `ctx.args.input.SERVICE_PARAM_MAPPING_ID` from the SERVICE_PARAM_MAPPING table.
 * @param {import('@aws-appsync/utils').Context} ctx the context
 * @returns {*} the request
 */
export function request(ctx) {
    const { input: { SERVICE_PARAM_MAPPING_ID }, condition = {} } = ctx.args;
    const where = {
        ...condition,
